/* ----------------------------------------------------------------------
   ...
   $Source: /usr/export/cvsroot/util/deapi/c++/main/dealingtools/orc/deapi/Connection.cc,v $
   $Revision: 1.1.1.1 $

   ---------------------------------------------------------------------- */

static char rcsid[] = "$Id: Connection.cc,v 1.1.1.1 2004/05/10 14:06:02 john Exp $";
